...
export default function KontaktPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* ── 2. Kontakt-Kacheln ── */}
      <section className="py-16 bg-brand-surface" data-navbar-theme="light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a
              ...
              className="group flex items-start gap-4 p-6 bg-white rounded-2xl border border-brand-border hover:border-brand-electric/30 hover:shadow-md transition-all duration-200"
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-brand-blue-tint flex items-center justify-center group-hover:bg-brand-electric/10 transition-colors">
                <Phone size={22} className="text-brand-electric" />
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.08em] text-brand-muted font-sans mb-1">Telefon</p>
                <p className="text-lg font-semibold text-brand-midnight font-sans">(0561) 10 44 75</p>
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-brand-blue-tint flex items-center justify-center group-hover:bg-brand-electric/10 transition-colors">
                <Mail size={22} className="text-brand-electric" />
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.08em] text-brand-muted font-sans mb-1">E-Mail</p>
                <p className="text-lg font-semibold text-brand-midnight font-sans">kassel@laufladen.de</p>
                <p className="text-xs text-brand-slate font-sans mt-1">Antwort innerhalb von 24 h</p>
              </div>
            </a>

            {/* Adresse */}
            <div className="flex items-start gap-4 p-6 bg-white rounded-2xl border border-brand-border">
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-brand-blue-tint flex items-center justify-center">
                <MapPin size={22} className="text-brand-electric" />
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.08em] text-brand-muted font-sans mb-1">Adresse</p>
                <p className="text-lg font-semibold text-brand-midnight font-sans">Friedrichsplatz 12</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Google Maps */}
            <div className="rounded-2xl overflow-hidden border border-brand-border shadow-sm aspect-[4/3]">
              <iframe
            ...
            <div>
              ...
              <h2 className="h2 text-brand-text mb-6">Wann du uns findest</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <h2 className="h2 text-brand-text mb-4">Hast du eine Frage?</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="h2 text-brand-text mb-8">So findest du uns</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex items-start gap-4 p-5 bg-brand-surface rounded-2xl border border-brand-border">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-white flex items-center justify-center border border-brand-border">
                  <Car size={20} className="text-brand-midnight" />
                </div>
                <div>
                  <p className="text-sm font-semibold text-brand-midnight font-sans">Parkhaus Friedrichsplatz</p>
              ...
              <div className="flex items-start gap-4 p-5 bg-brand-surface rounded-2xl border border-brand-border">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-white flex items-center justify-center border border-brand-border">
                  <Navigation2 size={20} className="text-brand-midnight" />
                </div>
                <div>
                  <p className="text-sm font-semibold text-brand-midnight font-sans">ÖPNV</p>
                  <p className="text-xs text-brand-slate font-sans mt-1 leading-relaxed">
      ...
      {/* ── 6. Social CTA ── */}
      <section className="py-20 bg-brand-midnight" data-navbar-theme="dark">
